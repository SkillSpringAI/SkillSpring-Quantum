...
| 21 Jul 2026 | `0.1.0-beta.3` Gemini attachment-only Takeout, Auto Detect | Passed | Export Check showed `Gemini chat history not found`, `0 import-ready`, 353 files not used, and no Import action. | Closed |
